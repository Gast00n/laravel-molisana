...
Route::get('/', function () {
    ...
    // Lavoro i dati ricevuti per ottenere array divisi secondo il tipo di pasta
    $lunghe = [];
    $corte = [];
    $cortissime = [];
    ...
    // Funzione Dump&Die per controllare in fase di produzione, un'alternativa è usare il dump();
    // dd($data);
